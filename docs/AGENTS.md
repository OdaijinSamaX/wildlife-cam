...
| 部品 | 最大寸法 | 備考 |
|---|---|---|
| **SORACOM Onyx (SC-QGLC4-C1)** | **95 mm** | **筐体内で最長。** USB-A プラグ直付けのドングルで、抜き差し代を含めると **110 mm 前後の直線的な空き**が要る。外部アンテナ (CRC9 x 2) の位置が未確定なので、いまは長辺の両側に 27 mm ずつ逃げを取ってある |
| 850 nm IR 投光器 | 45 mm | 推定寸法。発熱するので外気に面させるか放熱経路を別に設計する |
| Pi Zero 2 W | 65 mm | 実装部品高さとコネクタ抜き差し代は推定 |
| HC-SR501 PIR | 32 mm | 全寸法が推定 |
| Camera Module 3 NoIR | 25 mm | レンズ鏡筒は推定 |
